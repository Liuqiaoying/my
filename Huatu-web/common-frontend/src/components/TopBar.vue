            ...
            <div style="display: flex;align-items: center">
                <el-dropdown
                    ...
                    <div class="el-dropdown-trigger">
                        ...
                        <span class="name"
                            v-cloak
                            v-if="userInfo.name">{{userInfo.name}}({{userInfo.staffNo}})
                    ...
                    <el-dropdown-menu slot="dropdown">
                        ...
                        <el-dropdown-item
                            ...
                            ? userInfo.curRole.roleId == item.roleId && userInfo.curRole.nodes[0].id == item.nodes[0].id
                            : userInfo.curRole.roleId == item.roleId}"
                            @click.native="changeRole(item)">
                                {{item.roleName}}<span
                                    v-if="item.nodes && item.nodes.length && item.nodes[0]"
                                    class="text-gray-light role-item-node">[{{item.nodes[0].name}}]</span>
                            </el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
                <template v-else>
                    ...
                    <span class="name"
                        v-cloak
                        v-if="userInfo.name">{{userInfo.name}}({{userInfo.staffNo}})</span>
                </template>
                <el-popover
